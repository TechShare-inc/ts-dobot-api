...
if TYPE_CHECKING:
    from .api_namespaces import (
        Config, Conveyor, ErrorHandling, Feedback, ForceControl, Io,
        Lifecycle, Modbus, Motion, Query, Raw, RelativeMotion, System, Welding
    )
...
class DobotRobot(Generic[_T_Native]):
    ...
    @property
    def ip(self) -> str: return self._ip
    @property
    def model(self) -> str: return self._model
    @property
    def family(self) -> RobotFamily: return self._family
    @property
    def api_version(self) -> ApiVersion: return self._api_version
    @property
    def native(self) -> _T_Native: return self._native

    def __enter__(self) -> DobotRobot[_T_Native]: return self
